...
var Monitorallcontent = React.createClass({
    ...
    listenSelectCarData: function(data) {
        ...
        console.log('listenSelectCarData');
        console.log(data.infor);
        if(data.infor[4][1]==='巡逻一大队')
        {
        	this.state.service_type = 0;
        }
        else if(data.infor[4][1]==='巡逻二大队')
        {
    ...
    listenBoundsearchentity(data) {
        ...
        let markerArr = [];
        let MarkerOption = {};
           console.log('listenBoundsearchentity');
           console.log(data);
        ...
        if (data.length === 0) {
            ...
            data.map(function (item, index) {
                ...
                let img = mapControl.getEntityIcon(item.group, item);
                img.onload = function () {
                    markerArr.push({
                        geometry: {
                            type: 'Point',
