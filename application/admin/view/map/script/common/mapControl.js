...
window.mapControl = {
    ...
    initMap: function() {
        ...
        window.map = new BMap.Map("mapContainer", {enableMapClick: false});
      
        map.centerAndZoom(new BMap.Point(106.907591,29.893223), 14);  // 初始化地图,设置中心点坐标和地图级别
    ...
    */
    ...
    setEntityMarker(data, service_type) {
        ...
        if (service_type === 0) {
            ...
            switch (status.substring(0, 2)) {
                case '离线':
                    iconUrl = __uri('/static/images/endpointoffline.png');
                    break;
                case '静止':
                    iconUrl = __uri('/static/images/endpoint.png');
                    break;
                default:
                    iconUrl = __uri('/static/images/endpointonline.png');
                    break;
            }
        ...
        this.entityMarker.addEventListener('click', function (e) {
         ...
         switch (status.substring(0, 2)) {
                ...
                case '静止':
                    ...
                    break;
                default:
                    //this.entityMarker.setAnimation(BMAP_ANIMATION_BOUNCE);
                    break;
            }
