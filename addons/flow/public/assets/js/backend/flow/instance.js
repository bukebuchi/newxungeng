                ...
                table1.bootstrapTable({
                    ...
                    columns: [
                        [
                            ...
                            {field: 'instancecode', title: __('Instancecode')},
                ...
                table2.bootstrapTable({
                    ...
                    columns: [
                        [
                            ...
                            {field: 'instancecode', title: __('流水号')},
                            {field: 'id', title: __('id'), visible: false, operate: false},
                            ...
                            {field: 'status', title: '状态', formatter: Controller.api.formatter.status, searchList: [{id: 1, name: '审批中'}, {id: 2, name: '已完成'}]},
