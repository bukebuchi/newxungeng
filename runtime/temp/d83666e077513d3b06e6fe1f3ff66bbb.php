        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap" data-operate-edit="<?php echo $auth->check('dispute/edit'); ?>" data-operate-del="<?php echo $auth->check('dispute/del'); ?>" width="100%">
                    </table>
                </div>
            </div>
        </div>
