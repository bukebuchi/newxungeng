<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"C:\www\addons\voicenotice\view\index\index.html";i:1596072452;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div id="output">
        <div class="containerT">
            ...
            <form class="form" method="post">
                <input type="text" name="text1" value="" placeholder="下发命令">
                <div style="margin: 20px 0;">
                                      
                                        <select name="text" class="selectpicker" title="警情类型" multiple>
                                            <option value="紧急求援">紧急求援</option>
                                            <option value="交通堵塞">交通堵塞</option>
                                            <option value="山石滑坡">山石滑坡</option>
                                            <option value="抢救病人">抢救病人</option>
                                        </select>
                </div>

                <div style="margin: 20px 0;">
                    <select class="selectpicker" name="admin[]" title="管理员" multiple>
                ...
                <div style="margin: 10px 0">
                    <select class="selectpicker" multiple title="管理组" name="group[]">
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $vo['id']; ?>"><?php echo __($vo['name']); ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
                ...
                <div style="margin: 20px 0;" hidden=''>
                    <span style="font-size: 20px;color: red">播放次数：</span>
                    <input placeholder="默认true表示循环播放直到点击" type="number" name="loop" value="true">
                </div>


                <div style="margin: 10px 0" hidden=''>
                    <select class="selectpicker" title="打开窗口方式" name="url_type">
                        <option value="open">弹窗</option>
                        <option value="addtabs">侧边栏</option>
                    </select>
                </div>

                <div style="margin: 10px 0" hidden=''>
                    <span style="font-size: 20px;color: red">打开链接：</span>
                    <input name="url" type="text" value="https://www.fastadmin.net/">
                </div>
